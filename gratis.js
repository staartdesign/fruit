...
define("scripts/game.js", function (exports) {
    ...
    exports.start = function () {
        snd = sound.create("/assets/sound/throw");
        boomSnd = sound.create("/assets/sound/boom");
    ...
    exports.sliceAt = function (fruit, angle) {
        ...
        if (fruit.type != "boom") {
            ...
            let fruitValue = 0.05;
            if (fruit.type == "maca") { fruitValue = 0.05; }
            ...
            else if (fruit.type == "laranja") { fruitValue = 0.75; }
    ...
    message.addEventListener("fruit.fallOutOfViewer", function (fruit) {
        ...
        if (fruit.type != "boom") {
            ...
            /* --------------------------- */
            let fruitPerda = 0.10;
            if (fruit.type == "maca") { fruitPerda = 0.10; }
            else if (fruit.type == "maracuja") { fruitPerda = 0.20; }
            else if (fruit.type == "melancia") { fruitPerda = 0.30; }
            else if (fruit.type == "manga") { fruitPerda = 0.40; }
            else if (fruit.type == "abacate") { fruitPerda = 0.50; }
            else if (fruit.type == "mamao") { fruitPerda = 0.60; }
            else if (fruit.type == "banana") { fruitPerda = 0.70; }
            else if (fruit.type == "limao") { fruitPerda = 0.80; }
            else if (fruit.type == "roma") { fruitPerda = 0.90; }
            else if (fruit.type == "morango") { fruitPerda = 1.00; }
            else if (fruit.type == "laranja") { fruitPerda = 1.50; }
            else if (fruit.type == "kiwi") { fruitPerda = 2.00; }
            else if (fruit.type == "dragao") { fruitPerda = 4.00; }
...
define("scripts/main.js", function (exports) {
    ...
    exports.start = function () {
        ...
        log("Separando pr̻mios");
        log("Criando frutas b̫nus");
        log("Afiando facas");
        log("Pronto!");
        log.clear();
...
define("scripts/sence.js", function (exports) {
    ...
    // initialize sence
    exports.init = function () {
        menuSnd = sound.create("/assets/sound/menu");
        gameStartSnd = sound.create("/assets/sound/start");
...
define("scripts/factory/fruit.js", function (exports) {
    ...
    var infos = {
        ...
        boom: ["/assets/img/game/fruit/boom.png", 66, 68, 26, 0, 0, null],
        maca: ["/assets/img/game/fruit/maca.png", 62, 66, 31, -54, 0, "#98191e"],
        maracuja: ["/assets/img/game/fruit/maracuja.png", 62, 62, 37, -50, 0, "#e2bc30"],
        melancia: ["/assets/img/game/fruit/melancia.png", 90, 80, 38, -100, 0, "#94b167"],
        manga: ["/assets/img/game/fruit/manga.png", 62, 70, 32, -135, 0, "#d99c22"],
        abacate: ["/assets/img/game/fruit/abacate.png", 66, 80, 32, -135, 0, "#555b1f"],
        mamao: ["/assets/img/game/fruit/mamao.png", 62, 85, 32, -135, 0, "#94aa30"],
        banana: ["/assets/img/game/fruit/banana.png", 80, 60, 32, -135, 0, "#f5e330"],
        limao: ["/assets/img/game/fruit/limao.png", 65, 65, 37, -50, 0, "#fcf279"],
        roma: ["/assets/img/game/fruit/roma.png", 65, 65, 32, -135, 0, "#841d1c"],
        morango: ["/assets/img/game/fruit/morango.png", 62, 65, 32, -135, 0, "#c54624"],
        laranja: ["/assets/img/game/fruit/laranja.png", 70, 70, 32, -135, 0, "#c27811"],
        kiwi: ["/assets/img/game/fruit/kiwi.png", 68, 74, 32, -135, 0, "#76561d"],
        dragao: ["/assets/img/game/fruit/dragao.png", 70, 80, 32, -135, 0, "#c34d46"]
    };
    ...
    ClassFruit.prototype.set = function (hide) {
        ...
        this.shadow = layer.createImage("fruit", "/assets/img/game/shadow.png", this.startX - radius, this.startY - radius + shadowPos, 106, 77);
		...
		/* methods */ {
            ...
            usePNGbackground: function (image) {
                ...
                if (/\.png$/i.test(image) && ucren.isIe6) {
                    ...
                    /// 	_background: none;
                    ///  _filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='/assets/img/game/pic.png',sizingMethod='scale');
                } else {
...
define("scripts/object/background.js", function (exports) {
    ...
    exports.set = function () {
        image = layer.createImage("default", "/assets/img/game/background.jpg", 0, 0, screenW, screenH);
    };
...
define("scripts/object/developing.js", function (exports) {
    ...
    exports.set = function () {
        this.image = layer.createImage("default", "/assets/img/game/developing.png", 103, 218, 429, 53).hide().scale(1e-5, 1e-5);
    };
...
define("scripts/object/dojo.js", function (exports) {
    ...
    exports = rotate.create("/assets/img/game/dojo.png", 41, 240, 175, 175, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/flame.js", function (exports) {
    ...
    exports.create = function (ox, oy, start) {
        ...
        var nx = ox, ny = oy;
        var image = layer.image("/assets/img/game/smoke.png", nx - 21, ny - 21, 43, 43).hide();
        var flames = {};
...
define("scripts/object/flash.js", function (exports) {
    ...
    exports.set = switchOn ? function () {
        image = layer.createImage("flash", "/assets/img/game/flash.png", 0, 0, 358, 20).hide();
        snd = sound.create("/assets/sound/splatter");
    } : ucren.nul;
...
define("scripts/object/game-over.js", function (exports) {
    ...
    exports.set = function () {
        this.image = layer.createImage("default", "/assets/img/game/game-over.png", (screen.width - 300) / 2, 198, 300, 65).hide().scale(1e-5, 1e-5);
    };
...
define("scripts/object/home-desc.js", function (exports) {
    ...
    exports = displacement.create("/assets/img/game/home-desc.png", 161, 91, -161, 140, 7, 127, tween.exponential.co, 500);;
...
define("scripts/object/home-mask.js", function (exports) {
    ...
    exports = displacement.create("/assets/img/game/home-mask.png", screenW, 183, 0, -183, 0, 0, tween.exponential.co, 1e3);;
...
define("scripts/object/logo.js", function (exports) {
    ...
    exports = displacement.create("/assets/img/game/logo.png?v=1.0", 320, 150, 17, -182, 17, 1, tween.exponential.co, 1e3);;
...
define("scripts/object/lose.js", function (exports) {
    ...
    var conf1 = { src: "/assets/img/game/x.png", sx: 650, ex: (screen.width - 95), y: 5, w: 22, h: 19 };
    var conf2 = { src: "/assets/img/game/xx.png", sx: 671, ex: (screen.width - 71), y: 5, w: 27, h: 26 };
    var conf3 = { src: "/assets/img/game/xxx.png", sx: 697, ex: (screen.width - 40), y: 6, w: 31, h: 32 };
    ...
    function createPosShow(x) {
        var image = layer.createImage("default", "/assets/img/game/lose.png", x - 27, screenH - 150, 54, 50).scale(1e-5, 1e-5);
        var duration = 500;
...
define("scripts/object/new-game.js", function (exports) {
    ...
    exports = rotate.create("/assets/img/game/new-game.png", (screen.width - 195) / 2, 160, 195, 195, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/new.js", function (exports) {
    ...
    exports.set = function () {
        image = layer.createImage("default", "/assets/img/game/new.png", sx, sy, sw, sh);
    };
...
define("scripts/object/ninja.js", function (exports) {
    ...
    exports = displacement.create("/assets/img/game/ninja.png", 244, 81, 315, -140, 315, 43, {
...
define("scripts/object/quit.js", function (exports) {
    ...
    exports = rotate.create("/assets/img/game/quit.png", 493, 311, 141, 141, 1e-5, tween.exponential.co, 500);;
...
define("scripts/object/score.js", function (exports) {
    ...
    exports.set = function () {
        image = layer.createImage("default", "/assets/img/game/coin.png", imageSx, 8, 29, 31).hide();
        text1 = layer.createText("default", "0.00", text1Sx, 24, "90-#fc7f0c-#ffec53", "30px").hide();
        text2 = layer.createText("default", "Rodada demo!", text2Sx, 58, "#af7c05", "14px").hide();
    };
